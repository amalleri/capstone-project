...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Owner is not a valid address");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(tokenId > 0, "Token should be more than 0");
        address owner = _tokenOwner[tokenId];
        require(owner != address(0), "Owner does not exist for the provided tokenId");
        return owner;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Owner cannot be similar to the to address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), 
            "Either msg sender is not the owner or approval is not available for the sender");
